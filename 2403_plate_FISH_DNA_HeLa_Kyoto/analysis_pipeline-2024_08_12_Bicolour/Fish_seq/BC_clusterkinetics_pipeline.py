...
DATASET = "2404_plate-FISH_DNA_HeLa_RPAP3-Suntag" # For a new dataset add config first in input_config.py
MULTICHANNEL = False

path_in = "/media/floricslimani/SSD 4To/SSD_floricslimani/Fish_seq/input/"
path_out = "/media/floricslimani/SSD 4To/SSD_floricslimani/Fish_seq/output/"
...
min_spot_number_per_cluster_rna1 = 3
min_spot_number_per_cluster_rna2 = 3
min_spot_number_per_cluster_suntag = 3
sample_size = 8
...
from input_config import REGEX, CHANNELS, COLUMNS, GROUP_KEYS, THRESHOLDS
regex = REGEX[DATASET]
