...
#2.
COLUMNS = {
    #dataset :['date', 'cell_line', 'rna1', 'treatment', 'fov_number']
    ...
    ,"2404_plate-FISH_DNA_HeLa_RPAP3-Suntag" : ['rna3','treatment','rna1','rna2','fov','channel']
}
...
GROUP_KEYS = {
    ...
    ,"2404_plate-FISH_DNA_HeLa_RPAP3-Suntag" : ['rna1','rna2']
    ,"240429_time_course_CB" : ['cell_line']
}
